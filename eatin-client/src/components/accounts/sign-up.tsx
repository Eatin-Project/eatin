...
function SignUp() {
    ...
    const handleSubmit = async (event: FormEvent<HTMLFormElement>) => {
        ...
        try {
            setLoading(true);
            const userCredential = await signUpUser(firstName, lastName, email, password, phone, gender, dateOfBirth, country);
                    ...
                    <div className="mb-3">
                        <Dropdown>
                            <DropdownToggle id="dropdown" className="form-control">
                                {!!formFields.gender ? formFields.gender : "Gender"}</DropdownToggle>
