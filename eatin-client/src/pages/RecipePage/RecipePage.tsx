...
import {RecommendedFeed} from "../homePage/RecommendedFeed";
...
export const RecipePage: FC = () => {
    ...
    const {data: recommendedRecipes, loading: recommendedRecipesLoading} = useGetSimilarRecipes(Number(id));
    const {
    ...
    return (
        <div>
            ...
            <RecommendedFeed currentRecipes={recipesData} isLoadingCurrentRecipes={updateSavedStateLoading}
