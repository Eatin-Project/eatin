...
type AutocompleteValue<Multiple extends boolean | undefined> =
  Multiple extends true ? AutocompleteItem[] : AutocompleteItem | null;
...
export function Autocomplete<T extends boolean | undefined>({
  ...
  const handeValueChange: MuiAutocompleteProps<T>["onInputChange"] = (
    e,
    value
  ) => {
    onInputChange?.(value);
